...
# Divoom API <!-- omit in toc -->
This is a collection of information on the API of several Divoom devices. Hopefully the Pixoo behaves similarly
...
### 0x2D Select 12 or 24 hour clock
...
### 0x5F Set Temperature and Weather
...
### 0x46 Requesting Settings

Full String: `46`<br />
The box will answer with a message. See [here](#command-46) for how to interpret the answer.

### 0x45 Switching to a channel

In the Divoom App ther are "Weather", "Temperature", "Calendar" and an animaiton channel listed for the Pixoo on the clock page.
The Pixoo features radio, stopwatch, scorebaord, .. as well. Are they treated as channels?
...
I think the channels differ per model. Needs testing.

#### Time

Full String: `4500 HH TT XX WW EE CC RRGGBB`
...
```
#### Stopwatch
Control Halt/Reset (optional): 00 (Halt), 02 (Reset), 01 Start?

### 0x18 Set Time

Full String: `18 XX YY MM DD HH II SS
...
### 0x05 Set FM Radio (Timebox / Aurabox only?)
: Full String: `05 TT XX YY`
  `TT State (on = 01, off = 00)  
  `XXYY` Frequency in MHz: YYX.X (100.3 Mhz = YYX.X = 030A)  

### 0x60 Get FM Radio Frequency

Full String `60` 
  -> `XXYY` Frequency in MHz: YYX.X 

### 0x61 Set FM Radio Frequency: 

Full String `61 XX YY`
...
### 0x50 Set Notification
  -> Type: 00 - FF  

### 0x54 Set Calendar or Appointment Planer 
  -> needs further investigation  

Screen Off: 41XX or 62XX  

### 0x71 Show/Set Stopwatch/Scoreboard
